                ...
                <h3 class="text-dark mt-5">Edit Topic</h3>
                        ...
                        <div class="row">
                           ...
                           <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mt-2 p-2">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $studentregno; ?>" id="name" name="studentregno">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mt-2 p-2">
                                        <label for="name" class="text-dark">Date</label>
                                        <input type="text" class="form-control" value="<?php echo $studentdate; ?>" id="name" name="studentdate">
                                    </div>
                                </div>
                            </div>
                           </div>
                            ...
                            <div class="col-md-12">
                                <div class="mt-2 p-2">
                                    <label for="name" class="text-dark">Project Topic</label>
                                    <input type="text" class="form-control" value="<?php echo $studenttopic; ?>" id="name" name="studenttopic">
                                </div>
                            </div>

                        
                            <div class="mt-2 p-2">
                                <input type="submit" value="UPDATE" class="btn btn-lg bg-success text-light form-control" style="letter-spacing: 1vh" id="name" name="updatehnd">
                            </div>
                            <br>
                    </div>
