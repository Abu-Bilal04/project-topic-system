			...
			<div class="col-md-6 mx-auto border p-5">
				<section id="login" class="login">
					...
					<div class="log">
						...
						<div class="mt-3">
						<button class="btn btn-lg text-light container" name="adminLogin"><span id="spinner" class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="width: 20px; height: 20px;display: none;"></span><span class="bi bi-lock-fill" id="lock" style="color:white"></span>Login</button>
						</div>
